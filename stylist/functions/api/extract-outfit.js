// Cloudflare Pages Function — POST /api/extract-outfit
// Accepts a (typically AI-generated) fashion image and returns identified
// outfit items with Japanese search keywords for e-commerce search.
...
export async function onRequestPost(context) {
  ...
  try {
    const { result } = await runOutfitExtraction(env.GEMINI_API_KEY, {
      imageBase64,
      mediaType,

...
cp "/Users/mizutanimasahiro/.gemini/antigravity/brain/894164f2-e8bd-41f2-a96f-67a13e9f61e4/media__1774497521096.png" "./assets/youtube_mv.jpg" 2>/dev/null

echo "✅ 新しい画像ファイル（グッズ、特設サイト、実写キャラ、MV記録）を上書きしました。"

# GitHubへのプッシュ（認証はgit configに保存済み）
git add .
git commit -m "Update final images and MV thumbnail"
